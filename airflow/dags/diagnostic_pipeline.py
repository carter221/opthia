    ...
    try:
        ...
        with torch.no_grad():
            ...
            if model_type == 'rd':
                ...
                recommendation = "⚠️ RÉTINOPATHIE DIABÉTIQUE DÉTECTÉE - Veuillez consulter un médecin" if prediction_binary == 1 else "✅ Aucune rétinopathie détectée"
                ...
                recommendation = "⚠️ GLAUCOME DÉTECTÉ - Veuillez consulter un médecin" if prediction == 1 else "✅ Aucun glaucome détecté"
